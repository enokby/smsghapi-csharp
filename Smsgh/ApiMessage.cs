...
namespace SmsghApi.Sdk.Smsgh
{
    ...
    public class ApiMessage
    {
        ...
        /// </summary>
        public ApiMessage(ApiDictionary jso)
        {
            foreach (string key in jso.Keys)
            {
                switch (key.ToLower())
                {
                    ...
                    case "time":
                        ...
                        DateTime time;
                        if (jso[key].ToString() != "")
                            Time = DateTime.TryParseExact(jso[key].ToString(), "yyyy-dd-MM hh:mm:ss",
                    ...
                    case "updatetime":
                        ...
                        if (jso[key].ToString() != "")
                            _updateTime = DateTime.TryParseExact(jso[key].ToString(), "yyyy-dd-MM hh:mm:ss",
