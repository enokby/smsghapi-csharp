...
namespace SmsghApi.Sdk.Smsgh
{
    public class ApiTicket
    {
        ...
        private readonly List<ApiTicketResponse> _responses;
        ...
        public ApiTicket(ApiDictionary jso)
        {
            _responses = new List<ApiTicketResponse>();
            foreach (string key in jso.Keys)
            {
                switch (key.ToLower())
                {
                    ...
                    case "timeadded":
                        ...
                        {
                            DateTime timeParsed;
                            _timeAdded = DateTime.TryParseExact(jso[key].ToString(), "yyyy-dd-MM hh:mm:ss",
                                CultureInfo.InvariantCulture, DateTimeStyles.None, out timeParsed)
                                ? timeParsed
                                : (DateTime?) null;
                        }
                        break;
                    case "timeclosed":
                        ...
                        {
                            DateTime timeParsed;
                            _timeClosed = DateTime.TryParseExact(jso[key].ToString(), "yyyy-dd-MM hh:mm:ss",
                                CultureInfo.InvariantCulture, DateTimeStyles.None, out timeParsed)
                                ? timeParsed
                                : (DateTime?) null;
                        }
                    ...
                    case "timeassigned":
                        ...
                        {
                            DateTime timeParsed;
                            _timeAssigned = DateTime.TryParseExact(jso[key].ToString(), "yyyy-dd-MM hh:mm:ss",
                                CultureInfo.InvariantCulture, DateTimeStyles.None, out timeParsed)
                                ? timeParsed
                                : (DateTime?) null;
                        }
                    ...
                    case "lastupdated":
                        ...
                        {
                            DateTime timeParsed;
                            _lastUpdated = DateTime.TryParseExact(jso[key].ToString(), "yyyy-dd-MM hh:mm:ss",
                                CultureInfo.InvariantCulture, DateTimeStyles.None, out timeParsed)
                                ? timeParsed
                                : (DateTime?) null;
                        }
                    ...
                    case "responses":
                        ...
                        if (os != null)
                            foreach (JObject o in os)
                                _responses.Add(new ApiTicketResponse(o.ToObject<ApiDictionary>()));
                        break;
                }
            }
        }
        ...
        [JsonIgnore]
        public List<ApiTicketResponse> Responses
        {
