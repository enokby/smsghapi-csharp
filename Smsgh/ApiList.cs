        ...
        public ApiList(ApiDictionary jso)
        {
            ...
            foreach (string key in jso.Keys)
                switch (key.ToLower())
                {
                    ...
                    case "actionlist":
                        ...
                        if (apiArray != null)
                            foreach (JObject o in apiArray)
                                _items.Add((T) Convert.ChangeType
                                    (new ApiAction(o.ToObject<ApiDictionary>()), typeof (T)));
                        break;
                    ...
                    case "campaignlist":
                        ...
                        if (array != null)
                            foreach (JObject o in array)
                                _items.Add((T) Convert.ChangeType
                                    (new ApiCampaign(o.ToObject<ApiDictionary>()), typeof (T)));
                        break;
                    ...
                    //            _items.Add((T) Convert.ChangeType
                    //                (new ApiChildAccount(o.ToObject<ApiDictionary>()), typeof (T)));
                    //    break;
                    ...
                    case "contactlist":
                        ...
                        if (apiArray1 != null)
                            foreach (JObject o in apiArray1)
                                _items.Add((T) Convert.ChangeType
                                    (new ApiContact(o.ToObject<ApiDictionary>()), typeof (T)));
                        break;
                    ...
                    case "grouplist":
                        ...
                        if (array1 != null)
                            foreach (JObject o in array1)
                                _items.Add((T) Convert.ChangeType
                                    (new ApiContactGroup(o.ToObject<ApiDictionary>()), typeof (T)));
                        break;
                    ...
                    case "invoicestatementlist":
                        ...
                        if (os1 != null)
                            foreach (JObject o in os1)
                                _items.Add((T) Convert.ChangeType
                                    (new ApiInvoice(o.ToObject<ApiDictionary>()), typeof (T)));
                        break;
                    ...
                    case "messages":
                        ...
                        if (apiArray2 != null)
                            foreach (JObject o in apiArray2)
                                _items.Add((T) Convert.ChangeType
                                    (new ApiMessage(o.ToObject<ApiDictionary>()), typeof (T)));
                        break;
                    ...
                    case "messagetemplatelist":
                        ...
                        if (array2 != null)
                            foreach (JObject o in array2)
                                _items.Add((T) Convert.ChangeType
                                    (new ApiTemplate(o.ToObject<ApiDictionary>()), typeof (T)));
                        break;
                    ...
                    case "mokeywordlist":
                        ...
                        if (os2 != null)
                            foreach (JObject o in os2)
                                _items.Add((T) Convert.ChangeType
                                    (new ApiMoKeyWord(o.ToObject<ApiDictionary>()), typeof (T)));
                        break;
                    ...
                    case "numberplanlist":
                        ...
                        if (apiArray3 != null)
                            foreach (JObject o in apiArray3)
                                _items.Add((T) Convert.ChangeType
                                    (new ApiNumberPlan(o.ToObject<ApiDictionary>()), typeof (T)));
                        break;
                    ...
                    case "senderaddresseslist":
                        ...
                        if (array3 != null)
                            foreach (JObject o in array3)
                                _items.Add((T) Convert.ChangeType
                                    (new ApiSender(o.ToObject<ApiDictionary>()), typeof (T)));
                        break;
                    case "ticketlist":
                        ...
                        if (array4 != null)
                            foreach (JObject o in array4)
                                _items.Add((T) Convert.ChangeType
                                    (new ApiTicket(o.ToObject<ApiDictionary>()), typeof (T)));
                        break;
