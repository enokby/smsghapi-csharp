...
namespace SmsghApi.Sdk.Smsgh
{
    ...
    public class ApiNumberPlan
    {
        ...
        private readonly List<ApiNumberPlanItem> _numberPlanItems;
        ...
        /// </summary>
        public ApiNumberPlan(ApiDictionary jso)
        {
            _moKeywords = new List<ApiMoKeyWord>();
            _numberPlanItems = new List<ApiNumberPlanItem>();
            ...
            foreach (string key in jso.Keys)
                switch (key.ToLower())
                {
                    ...
                    case "dateactivated":
                        ...
                        _dateActivated = DateTime.TryParseExact(jso[key].ToString(), "yyyy-dd-MM hh:mm:ss",
                            CultureInfo.InvariantCulture, DateTimeStyles.None, out dateActivated)
                            ? dateActivated
                            : (DateTime?)null;
                    ...
                    case "datecreated":
                        ...
                        _dateCreated = DateTime.TryParseExact(jso[key].ToString(), "yyyy-dd-MM hh:mm:ss",
                    ...
                    case "datedeactivated":
                        ...
                        if (jso[key].ToString() != "")
                            _dateDeactivated = DateTime.TryParseExact(jso[key].ToString(), "yyyy-dd-MM hh:mm:ss",
                            CultureInfo.InvariantCulture, DateTimeStyles.None, out dateDeactivated)
                            ? dateDeactivated
                            : (DateTime?)null;
                        break;
                    case "dateexpiring":
                        ...
                        if (jso[key].ToString() != "")
                            _dateExpiring = DateTime.TryParseExact(jso[key].ToString(), "yyyy-dd-MM hh:mm:ss",
                            CultureInfo.InvariantCulture, DateTimeStyles.None, out dateExpiring)
                            ? dateExpiring
                            : (DateTime?)null;
                        break;
                    case "description":
                    ...
                    case "mokeywords":
                        ...
                        if (mos != null)
                            foreach (JObject o in mos)
                                _moKeywords.Add(new ApiMoKeyWord(o.ToObject<ApiDictionary>()));
                        break;
                    case "notes":
                    ...
                    case "numberplanitems":
                        ...
                        if (os != null)
                            foreach (JObject o in os)
                                _numberPlanItems.Add(new ApiNumberPlanItem(o.ToObject<ApiDictionary>()));
                        break;
                    ...
                    case "servicetype":
                        ...
                        _serviceType = new ApiServiceType(svc.ToObject<ApiDictionary>());
                        break;
                }
        }
