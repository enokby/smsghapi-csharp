...
namespace SmsghApi.Sdk.Smsgh
{
    ...
    public class ApiChildAccount
    {
        ...
        /// </summary>
        public ApiChildAccount(ApiDictionary jso)
        {
            foreach (string key in jso.Keys)
                switch (key.ToLower())
                {
                    ...
                    case "timecreated":
                        ...
                        if (jso[key].ToString() != "")
                            _timeCreated = DateTime.TryParseExact(jso[key].ToString(), "yyyy-dd-MM hh:mm:ss",
                    ...
                    case "timeremoved":
                        DateTime tmr;
                        if (jso[key].ToString() != "")
                            _timeRemoved = DateTime.TryParseExact(jso[key].ToString(), "yyyy-dd-MM hh:mm:ss",
                                CultureInfo.InvariantCulture, DateTimeStyles.None, out tmr)
                                ? tmr
                                : (DateTime?)null;
